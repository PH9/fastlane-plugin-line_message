...
require 'fastlane/plugin/line_message/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-line_message'
  spec.version       = Fastlane::LineMessage::VERSION
  spec.author        = 'Wasith Theerapattrathamrong'
